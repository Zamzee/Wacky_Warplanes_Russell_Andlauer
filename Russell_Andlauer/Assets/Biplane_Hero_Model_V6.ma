...
//Name: Biplane_Hero_Model_V6.ma
//Last modified: Fri, Feb 21, 2014 01:19:56 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.646854985033022 5.0335220376577379 16.167466890935074 ;
	setAttr ".r" -type "double3" -1.1999999999999758 -35.199999999990233 0 ;
...
createNode mesh -n "pasted__pCubeShape14" -p "pasted__pCube14";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 62 ".pt";
	setAttr ".pt[30]" -type "float3" 0.70847517 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[31]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[32]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[33]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[34]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[35]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[36]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[37]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[38]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[39]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[40]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[41]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[42]" -type "float3" 0.70847517 0 0 ;
	setAttr ".pt[43]" -type "float3" 0.70847517 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[44]" -type "float3" 0.70847517 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[45]" -type "float3" 2.4081461 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[46]" -type "float3" 2.4081461 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[47]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[48]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[49]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[50]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[51]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[52]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[53]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[54]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[55]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[56]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[57]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[58]" -type "float3" 2.4081461 0 0 ;
	setAttr ".pt[59]" -type "float3" 2.4081461 -1.1920929e-007 -1.4901161e-008 ;
	setAttr ".pt[60]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[61]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[62]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[63]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[64]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[65]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[66]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[67]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[68]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[69]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[70]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[71]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[72]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[73]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[74]" -type "float3" -1.1974037 0 0 ;
	setAttr ".pt[75]" -type "float3" -0.38196456 -1.3877788e-017 0 ;
	setAttr ".pt[76]" -type "float3" -0.38196456 -1.0408341e-017 0 ;
	setAttr ".pt[77]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[78]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[79]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[80]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[81]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[82]" -type "float3" -0.38196456 -1.3877788e-017 -1.110223e-016 ;
	setAttr ".pt[83]" -type "float3" -0.38196456 0 0 ;
	setAttr ".pt[84]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[85]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[86]" -type "float3" -0.38196456 0 -1.110223e-016 ;
	setAttr ".pt[87]" -type "float3" -0.38196456 0 0 ;
	setAttr ".pt[88]" -type "float3" -0.38196456 0 0 ;
	setAttr ".pt[89]" -type "float3" -0.38196456 0 0 ;
...
createNode transform -n "directionalLight1";
	...
	setAttr ".r" -type "double3" -83.137744347994072 -26.303617611435865 -40.610961386270183 ;
...
// End of Biplane_Hero_Model_V6.ma
